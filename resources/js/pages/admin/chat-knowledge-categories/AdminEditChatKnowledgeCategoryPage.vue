        ...
        <div class="max-w-2xl mx-auto">
            ...
            <template v-else>
                <div class="mb-8 flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Edit Chat Knowledge Categories</h1>
...
async function submit() {
    ...
    try {
        await axios.put(`/api/admin/chat-knowledge-categories/${route.params.id}`, form.value)
