        ...
        <div class="max-w-xl mx-auto">
            ...
            <template v-else>
                <div class="mb-8 flex items-center gap-3">
                    <RouterLink to="/admin/staff-positions" class="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 transition-colors">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-0.5">Update position details.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-2">
                            <button type="button" @click="router.push('/admin/staff-positions')" class="px-4 py-2 text-sm text-gray-500 hover:text-gray-700 transition-colors">Cancel</button>
...
async function submit() {
    ...
    try {
        await axios.put(`/api/admin/staff-positions/${route.params.id}`, form.value)
        router.push(`/admin/staff-positions/${route.params.id}`)
    } catch (e) {
