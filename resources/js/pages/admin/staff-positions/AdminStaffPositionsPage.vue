<template>
                                    ...
                                    <td class="px-6 py-3.5">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span v-if="can.delete" class="relative group">
                                                <a href="#" @click.prevent="position.staff_roles_count ? null : confirmDelete(position)"
                                                    :class="position.staff_roles_count ? 'opacity-40 cursor-not-allowed' : ''"
                                                ...
                                                <span v-if="position.staff_roles_count" class="pointer-events-none absolute bottom-full right-0 mb-1 whitespace-nowrap rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 group-hover:opacity-100 transition-opacity">In use — cannot delete</span>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
    ...
    <DeleteModal :show="!!deleteTarget" @confirm="deletePosition" @cancel="deleteTarget = null; deleteError = null"
        title="Delete Staff Position" message="Are you sure you want to delete this staff position?" :error="deleteError" />
</template>
