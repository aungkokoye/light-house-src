<template>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <template v-else>
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <RouterLink v-if="can('create')" to="/admin/products/create"
                                ...
                                <tr v-else v-for="product in products" :key="product.id" class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-3.5">
                                        <div class="flex items-center gap-1">
                                            <RouterLink v-if="can('view')" :to="`/admin/products/${product.id}`"
                                            ...
                                            <RouterLink v-if="can('edit')" :to="`/admin/products/${product.id}/edit`"
                                                class="p-1.5 text-indigo-600 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
                                            ...
                                            <button v-if="can('delete')" @click="confirmDelete(product)"
    ...
    <DeleteModal :show="!!deleteTarget" @confirm="deleteProduct" @cancel="deleteTarget = null"
