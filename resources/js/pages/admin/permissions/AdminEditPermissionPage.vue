        ...
        <div class="max-w-xl mx-auto">
            ...
            <template v-else>
                <div class="mb-8 flex items-center gap-3">
                    <RouterLink to="/admin/permissions" class="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 transition-colors">
...
async function submit() {
    ...
    try {
        ...
        router.push(`/admin/permissions/${route.params.id}`)
    } catch (e) {
...
onMounted(async () => {
    ...
    try {
        ...
        if (!e?.response) router.push('/admin/permissions')
    }
})
</script>