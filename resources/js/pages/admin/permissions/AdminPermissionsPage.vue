<template>
                                ...
                                <tr v-for="perm in permissions" :key="perm.id" class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-3.5">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <a v-if="can.delete" href="#" @click.prevent="confirmDelete(perm)"
    ...
    <DeleteModal :show="!!deleteTarget" @confirm="deletePermission" @cancel="deleteTarget = null"
        title="Delete Permission" message="Are you sure you want to delete this permission?" />
</template>
