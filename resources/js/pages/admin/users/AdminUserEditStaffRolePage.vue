        ...
        <div class="max-w-xl mx-auto">
            ...
            <template v-else>
                ...
                <div class="mb-8 flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Edit Staff Role</h1>
                        <p class="text-sm text-gray-500 mt-0.5">Role assignment #{{ route.params.roleId }}</p>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-1.5">
                                    End Date
                                    <span class="text-gray-300 font-normal">(blank = active)</span>
                                </label>
...
async function submit() {
    ...
    try {
        await axios.put(`/api/admin/users/${route.params.id}/staff-roles/${route.params.roleId}`, form.value)
...
onMounted(async () => {
    ...
    try {
        const [
            ...
            axios.get(`/api/admin/users/${route.params.id}/staff-roles/${route.params.roleId}`),
