<template>
                                    ...
                                    <td class="px-3 py-3.5 w-px whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <span v-if="can.delete" class="relative group">
                                                <a href="#" @click.prevent="u.invoices_count ? null : confirmDelete(u)"
                                                    :class="u.invoices_count ? 'opacity-40 cursor-not-allowed' : ''"
                                                ...
                                                <span v-if="u.invoices_count" class="pointer-events-none absolute bottom-full right-0 mb-1 whitespace-nowrap rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 group-hover:opacity-100 transition-opacity">Has invoices — cannot delete</span>
                                            </span>
                                        </div>
                                    </td>
                                </tr>
    ...
    <DeleteModal :show="!!deleteTarget" @confirm="deleteUser" @cancel="deleteTarget = null; deleteError = null"
        title="Delete User" message="Are you sure you want to delete this user?" :error="deleteError" />
</template>
