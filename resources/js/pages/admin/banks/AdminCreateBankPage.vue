        ...
        <div class="max-w-xl mx-auto">
            ...
            <template v-else>
                <div class="mb-8 flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">New Bank</h1>
                        <p class="text-sm text-gray-500 mt-0.5">Add a new payment bank.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    <form @submit.prevent="submit" class="space-y-5">
                        <div>
                            ...
                            <input v-model="form.name" type="text" placeholder="e.g. KBZ Bank"
                        ...
                        <div class="flex items-center justify-end gap-3 pt-2">
                            <RouterLink to="/admin/banks" class="px-4 py-2 text-sm text-gray-500 hover:text-gray-700 transition-colors">Cancel</RouterLink>
...
async function submit() {
    ...
    try {
        const { data } = await axios.post('/api/order/banks', form.value)
        router.push(`/admin/banks/${data.id}`)
    } catch (e) {
