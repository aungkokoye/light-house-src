        ...
        <div class="max-w-6xl mx-auto">
            ...
            <template v-else>
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <RouterLink v-if="can.create" to="/admin/roles/create"
                                ...
                                <tr v-for="role in roles" :key="role.id" class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-3.5">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <a v-if="can.delete" href="#" @click.prevent="confirmDelete(role)"
...
const STORAGE_KEY = 'admin_roles_state'
...
function restoreState() {
    ...
    sortBy.value   = state.sortBy  ?? 'updated_at'
...
function debouncedFetch() {
    ...
    searchTimer = setTimeout(() => fetchRoles(1), 350)
}
...
onMounted(async () => {
    ...
    fetchRoles(restored ? currentPage.value : 1)
})
</script>
