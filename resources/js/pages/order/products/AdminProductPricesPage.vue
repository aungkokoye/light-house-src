<template>
                            ...
                            <tbody class="divide-y divide-gray-50">
                                <tr v-for="(price, i) in prices" :key="price.id"
                                    ...
                                    <td v-if="can.delete" class="px-6 py-3.5">
                                        <a v-if="prices.length > 1" href="#" @click.prevent="confirmDelete(price)"
    ...
    <DeleteModal :show="!!deleteTarget" @confirm="deletePrice" @cancel="deleteTarget = null; deleteError = null"
        title="Delete Price" message="Are you sure you want to delete this price?" :error="deleteError" />
</template>
...
async function deletePrice() {
    ...
    try {
        ...
        deleteError.value = e?.response?.data?.message ?? 'Failed to delete price.'
    }
}
