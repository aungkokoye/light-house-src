        ...
        <div class="max-w-xl mx-auto">
            ...
            <template v-else>
                <div class="mb-8 flex items-center gap-3">
                    <RouterLink to="/order/products" class="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 transition-colors">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                <RouterLink :to="`/order/products/${route.params.id}/prices`"
...
async function submit() {
    ...
    try {
        ...
        router.push(`/order/products/${route.params.id}`)
    } catch (e) {
