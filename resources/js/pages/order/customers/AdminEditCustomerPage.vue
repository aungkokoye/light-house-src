            ...
            <template v-else>
                <div class="mb-8 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-0.5">Update customer details.</p>
                    </div>
                </div>
...
async function submit() {
    ...
    try {
        await axios.put(`/api/order/customers/${route.params.id}`, form.value)
        router.push(`/order/customers/${route.params.id}`)
    } catch (e) {
