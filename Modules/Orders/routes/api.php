...
Route::middleware(['auth:sanctum', 'role:admin|user'])->prefix('order')->group(function () {
    Route::get('/payment-types',                        [PaymentTypeController::class, 'index'])  ->can('viewAny', PaymentType::class);
    Route::post('/payment-types',                       [PaymentTypeController::class, 'store'])  ->can('create',  PaymentType::class);
    Route::get('/payment-types/{payment_type}',         [PaymentTypeController::class, 'show'])   ->can('view',    'payment_type');
    Route::put('/payment-types/{payment_type}',         [PaymentTypeController::class, 'update']) ->can('update',  'payment_type');
    Route::delete('/payment-types/{payment_type}',      [PaymentTypeController::class, 'destroy'])->can('delete',  'payment_type');
