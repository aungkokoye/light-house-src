...
return new class extends Migration
{
    ...
    {
        $now      = now();
        $company  = env('VITE_COMPANY_NAME',    'LightHouse');
        $address  = env('VITE_COMPANY_ADDRESS', '195(A) 33rd street, Upper Block, Kyauktada Township, Yangon, Myanmar');
        $phone    = env('VITE_COMPANY_PHONE',   '+95 9 782 275 275');
        $email    = env('VITE_COMPANY_EMAIL',   'info@lighthouse-print.com');
        $facebook = env('VITE_COMPANY_FACEBOOK','https://www.facebook.com/lhprint/');
        ...
        $categories = [
            ...
            ['name' => 'Contact',         'description' => "How to reach {$company}.",                              'sort_order' => 5],
        ...
        $entries = [
            ...
            [
                ...
                'title'      => "About {$company}",
                'content'    => "{$company} is a professional printing house based in Myanmar. We provide high-quality printing services to businesses and individuals across the country. Our management system handles customers, staff, orders, production workflows, and invoices.",
                'sort_order' => 1,
            ],
            [
                'chat_knowledge_category_id' => $cat('Overview'),
                'title'      => 'Our Mission',
                'content'    => "We are committed to delivering exceptional print quality with fast turnaround times. Whether you need business cards, brochures, banners, or large-format prints, {$company} has the expertise and equipment to bring your vision to life.",
                'sort_order' => 2,
            ],
            ...
            [
                ...
                'title'      => 'Opening Hours',
                'content'    => "{$company} is open Monday to Saturday, 9:00 AM – 6:00 PM.\nWe are closed on Sundays and all Myanmar public holidays.\n\nIf you contact us outside business hours, we will get back to you on the next working day.",
                'sort_order' => 1,
            ],
            [
                'chat_knowledge_category_id' => $cat('Business Hours'),
                'title'      => 'Public Holidays',
                'content'    => "All {$company} sites are closed on Myanmar public holidays. This includes Thingyan (Water Festival), Independence Day, Union Day, Workers Day, and other nationally observed holidays. Orders placed during holidays will be processed on the next working day.",
                'sort_order' => 2,
            ],
